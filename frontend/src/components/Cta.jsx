...
const Cta = (props) => {
  ...
  return (
    <button className={`${theme === "dark" ? "relative bg-gradient-to-b from-[#190d2e] to-[#4a208a] shadow-[0px_0px_12px_#8c45ff] hover:shadow-[0px_0px_16px_5px_#8c45ff]" : "bg-black hover:black-shadow"} xs:px-6 xs:py-2 rounded-[20px] w-auto md:px-12 md:py-4 md:rounded-[60px]`} aria-label={props.content}>
      <div className='absolute inset-0'>
        ...
        <div className='xs:rounded-[20px] md:rounded-[60px] absolute inset-0 shadow-[0_0_10px_rgb(140, 69, 255,.7)_inset]'></div>
      </div>
